...
**@brief   This Header File contains declaration of all the external function ,
					 Macros and External variables related CAN Parser.
******************************************************************************
*/    
...
* ----------------------------------------------------------------------------
*/
#define MODULE_CODE														(uint8_t)0x01
#define CODE_VERSION													2.6f
...
#define SOURCE_HCM														((uint32_t)0x00000003)		/*HCM source address*/
#define SOURCE_OPMM														((uint32_t)0x00000004)		/*OPMM source address*/
...
/*31st August2016*/
#define CMD_JOINT_MATERIAL_RESET							((uint32_t)0x00100000)		/*Reset Joint Number,Hardener Material,Base Material Screen*/
#define COMMAND_APPLY_WIFI_SETTING						((uint32_t)0x00110000)		/*Pressure Gauge Remapping change8*/	
#define CMD_REMOTE_BUTTON_PRESS								((uint32_t)0x00120000)		/*change20 Remote Button Press*/
...
#define FAULT_LOG_MEMORY_FULL_ERROR						((uint32_t)0x00110000)		/*FAULT_LOG_MEMORY_FULL_ERROR change4*/
...
#define STATUS_REMOTE_SW											((uint32_t)0x00140000)		/*Remote switch status change19*/
...
/*31st Aug 2016*/
#define DATA_ACC_MATERIAL_USAGE								((uint32_t)0x00170000)		/*Accumulated Material  Usage*/
...
#define CONFIG_STALL_TEST_LT_RANGES						((uint32_t)0x00380000)		/*stall test ranges of LT*/

/*20thJuly2016*/
#define CONFIG_IDEAL_PERIODIC_TIME						((uint32_t)0x00390000)		/*Ideal time for periodic log*/
#define CONFIG_JOB_NAME												((uint32_t)0x003A0000)		/*Job Name*/
#define CONFIG_PIPE_DIAMETER									((uint32_t)0x003B0000)		/*Pipe Diameter*/
#define CONFIG_ETH_WIFI_IP_SN_GW_PN						((uint32_t)0x003C0000)		/*change3*/
#define CONFIG_WIFI_SSID											((uint32_t)0x003D0000)		/*change3*/
#define CONFIG_WIFI_PASS											((uint32_t)0x003E0000)		/*change3*/

#define CONFIG_UTC_TIME_OFFSET								((uint32_t)0x003F0000)		/*Time Zone Offset change1*/

#define CONFIG_JOB_ID													((uint32_t)0x00400000)		/*change7 JOB ID */
