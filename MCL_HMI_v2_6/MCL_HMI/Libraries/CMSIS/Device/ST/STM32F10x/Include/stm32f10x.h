...
//  #define HSE_VALUE    ((uint32_t)16000000)						/*value changed for testing*/
	//#define HSE_VALUE    ((uint32_t)16000000) /*!< Value of the External oscillator in Hz */ //Changed for TRMC
 #endif /* STM32F10X_CL */
#endif /* HSE_VALUE */
