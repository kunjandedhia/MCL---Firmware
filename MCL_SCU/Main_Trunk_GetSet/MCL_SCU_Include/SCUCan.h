...
#define DEST_SOURCE_ADDR_CLEAR_MASK						((uint32_t)0xFFFF0000) //newly added by ketan
...
#define SOURCE_OPMM														((uint32_t)0x00000003)		/*HCM source address*/
#define SOURCE_HCM														((uint32_t)0x00000004)		/*OPMM source address*/
...
#define CMD_READ_PIPE_TEMP										((uint32_t)0x000D0000)		/*Start Stall test*/	
#define CMD_STOP_OPMM													((uint32_t)0x000E0000)		/*Start Stall test*/	
/****************************change11**********************************************************************/
#define COMMAND_RTN_HOME											((uint32_t)0x000F0000)		/*Pressure Gauge Remapping */
#define COMMAND_RESET_MATERIAL								((uint32_t)0x00100000)		/*Pressure Gauge Remapping change38*/	
#define COMMAND_APPLY_WIFI_SETTING						((uint32_t)0x00110000)		/*Pressure Gauge Remapping change45*/	
#define CMD_REMOTE_BUTTON_PRESS								((uint32_t)0x00120000)		/*change64 Remote Button Press*/
...
#define FAULT_ERROR_WARN_OCCUR								((uint32_t)0x000C0000)		/*HeartBeat Ack not Received*/
...
#define FAULT_LOG_MEMORY_FULL_ERROR						((uint32_t)0x00110000)		/*FAULT_LOG_MEMORY_FULL_ERROR change33*/
...
#define STATUS_FIRMWARE_VERSION_NUMBER				((uint32_t)0x00130000)		/*Software version Number change14*/
#define STATUS_REMOTE_SW											((uint32_t)0x00140000)		/*Remote switch status change63*/
/*****MESSAGE ID----FOR DATA*****/
...
#define DATA_MCU_AMB_HUMIDITY									((uint32_t)0x000A0000)		/*Ambient Humidity of out side the container*/
...
//#define DATA_OPMM_LINK_FAULT_CNT							((uint32_t)0x00170000)		/*OPMM CAN link fault count change20*/
//#define DATA_VCM_AIR_FLOW											((uint32_t)0x00180000)		/*OPMM CAN link fault count change20*/
...
#define CONFIG_FLUSH_WARNNING_TIME						((uint32_t)0x00150000)		/*Flush Warning Time*/
...
#define CONFIG_LT_REMAP									  		((uint32_t)0x00260000)		/*Pressure Gauge Remapping */
#define CONFIG_EE07_REMAP									  	((uint32_t)0x00270000)		/*Pressure Gauge Remapping */
#define CONFIG_STALL_VALVE_REMAP							((uint32_t)0x00280000)		/*Pressure Gauge Remapping */
#define CONFIG_THERMOCOUPLE_REMAP							((uint32_t)0x00290000)		/*Pressure Gauge Remapping */
#define CONFIG_SSR_REMAP									  	((uint32_t)0x002A0000)		/*Pressure Gauge Remapping */
#define CONFIG_LL_SENSOR_REMAP								((uint32_t)0x002B0000)		/*Pressure Gauge Remapping */
#define CONFIG_OPMM_VALVE_REMAP								((uint32_t)0x002C0000)		/*Pressure Gauge Remapping */
#define CONFIG_VCM_PERIPHRAL_BYPASS						((uint32_t)0x002D0000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_HCM_PERIPHRAL_BYPASS						((uint32_t)0x002E0000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_SCU_PERIPHRAL_BYPASS						((uint32_t)0x002F0000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_OPMM_PERIPHRAL_BYPASS					((uint32_t)0x00300000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_OPMM_NON_CONTACT_REMAP					((uint32_t)0x00310000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_TEMP_PRESS_ACHIEVE_BYPASS			((uint32_t)0x00320000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_OPMM_BUZZER_VOLUME							((uint32_t)0x00330000)		/*Pressure Gauge Remapping *///abk
#define CONFIG_SIGNATURE_BYTE									((uint32_t)0x00340000)		/*Pressure Gauge Remapping */
/****************************change8**********************************************************************/
#define CONFIG_OPMM_BATT_KNEE_VOLT						((uint32_t)0x00350000)		/*Pressure Gauge Remapping */
#define CONFIG_SCU_STALL_COMMAND_TIME					((uint32_t)0x00360000)		/*Pressure Gauge Remapping */
#define CONFIG_OPMM_STOP_HLS_TIME							((uint32_t)0x00370000)		/*Pressure Gauge Remapping */

/****************************change10**********************************************************************/
#define CONFIG_VCM_STALL_RANGE								((uint32_t)0x00380000)		/*Pressure Gauge Remapping */
/****************************change21**********************************************************************/
#define CONFIG_IDLE_DATA_LOG_PERIOD 					((uint32_t)0x00390000)		/*Pressure Gauge Remapping */
#define CONFIG_JOB_NAME												((uint32_t)0x003A0000)		/*Pressure Gauge Remapping */
#define CONFIG_PIPE_DIAMETER									((uint32_t)0x003B0000)		/*Pressure Gauge Remapping */
#define CONFIG_ETH_WIFI_IP_SN_GW_PN						((uint32_t)0x003C0000)		/*change28*/
#define CONFIG_WIFI_SSID											((uint32_t)0x003D0000)		/*change29*/
#define CONFIG_WIFI_PASS											((uint32_t)0x003E0000)		/*change29*/
#define CONFIG_TIME_ZONE_OFFSET								((uint32_t)0x003F0000)		/*change29*/
/*change42*/
#define CONFIG_JOB_ID													((uint32_t)0x00400000)		/*change42*/						
