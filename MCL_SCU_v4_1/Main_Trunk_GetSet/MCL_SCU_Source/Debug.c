...
**@file     :    Debug.c
* 
**@brief    :   This file contains the functions for debugging
******************************************************************************
*/
/* ----------------------------------------------------------------------------
*                           Includes
...
* Description	: The function below send a range of bytes on the UARTx TX line.
* Parameters		: ch : character for sending on USART  
* Return				: None  						   
*************************************************************************/ 
void uart1Send(unsigned char ch) 
{
...
**@Parameters		: char : *pcBuf, unsigned long : ulLen 
**@Return				: None  
*****************************************************************************/
int UARTwrite(const char *pcBuf, unsigned long ulLen)
{
...
* \return None.
*
**@Parameters		: const char : *pcString
**@Return				: None  
*****************************************************************************/
void UARTprintf(const char *pcString, ...)
{
  ...
  while(*pcString)
  {
    ...
    for(ulIdx = 0; (pcString[ulIdx] != '%') && (pcString[ulIdx] != NULL );
    ulIdx++)
    {
    }
      ...
      case 's':
        {
          ...
          for(ulIdx = 0; pcStr[ulIdx] != NULL; ulIdx++)
          {
          }
